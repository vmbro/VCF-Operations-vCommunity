...
4. ESXi Advanced System Settings Config File: esxi_advanced_system_settings.  This can be adjusted to include additional Advanced System Settings via Infrastructure Operations - Configurations - Management Pack Configuration - System Defined - esxi_advanced_system_settings.xml.  These are the System - Advanced System Settings as seen on ESXi Hosts in vCenter via the Configure tab.
...
8. Credential: this will be your vCenter credential and Windows credential, should you be collecting Windows Services and/or Events.
...
10. Advanced Settings - Windows Service Configuration File: windows_service_list.  This can be adjusted to include additional Windows Services via Infrastructure Operations - Configurations - Management Pack Configuration - System Defined.
11. Advanced Settings - Windows Event Log Configuration File: windows_event_list.  This can be adjusted to include additional Events via Infrastructure Operations - Configurations - Management Pack Configuration - System Defined.
12. Advanced Settings - Port: 443.  This is the default port for connectivity to vCenter
